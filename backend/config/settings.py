...
# - In production, always set DJANGO_SECRET_KEY.
# - In dev/tests, generate a temporary key if not provided.
...
ALLOWED_HOSTS = [
    h.strip()
    for h in os.environ.get("DJANGO_ALLOWED_HOSTS", "testserver,localhost,127.0.0.1").split(",")
    if h.strip()
]
